        ...
        <View style={styles.skeletonList}>
          {Array.from({ length: isCompact ? 2 : 5 }).map((_, index) => (
            <View
              ...
              style={[
                styles.skeletonCard,
                { borderColor: themeColor, backgroundColor: cardColor },
              ]}
            >
    ...
    if (isEmpty) {
      return (
        <View style={styles.cardCenteredContent}>
          <ThemedText
            style={[
              isCompact ? styles.compactEmptyTitle : styles.emptyText,
              { color: textColor },
            ]}
          >
          ...
          {isCompact && (
            <ThemedText
              style={[styles.compactEmptyDescription, { color: textColor }]}
            >
    ...
    return (
      <FlatList
        ...
        contentContainerStyle={
          isCompact ? styles.compactListContent : styles.fullListContent
        }
      ...
      {error && !isCompact && (
        <View
          style={[
            ...
            { backgroundColor: cardColor, borderColor: themeColor },
          ]}
        >
