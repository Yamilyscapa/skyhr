  ...
  const handleDetectionComplete = useCallback(
    async (image: CapturedImage | null) => {
      ...
      if (!locationReady || !latitude || !longitude) {
        setStatus({
          text: "Esperando la ubicación del dispositivo...",
          tone: "warning",
        });
        return;
      }
      ...
      try {
        ...
        const recordedAt = new Date(
          event.check_in ?? new Date().toISOString(),
        ).toLocaleTimeString();
        ...
        setStatus({
          text: `Asistencia registrada para ${user.name}.`,
          tone: "success",
        });
    ...
    return (
      <SafeAreaView style={styles.blockedContainer}>
        ...
        <Button
          ...
          accessibilityHint="Solicita acceso a la camara para el escaneo biometrico"
        >
          Otorgar permisos
        </Button>
        <Button
          ...
          accessibilityHint="Detiene el proceso y regresa a la pantalla anterior"
        >
          Cancelar
        </Button>
      </SafeAreaView>
  ...
  if (!locationReady) {
    return (
      <SafeAreaView style={styles.blockedContainer}>
        <ActivityIndicator size="large" color="#0F9D58" />
        <ThemedText style={styles.blockedText}>
          Sin coordenadas disponibles todavía…
        </ThemedText>
      </SafeAreaView>
    );
  }
        ...
        <View style={styles.overlay}>
          <View style={styles.topBar}>
            ...
            <Pressable
              ...
              accessibilityLabel="Detener modo vigilante"
              accessibilityHint="Detiene el modo vigilante y sale del escaneo biometrico"
            >
